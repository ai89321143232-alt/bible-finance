        ...
        return (
          <section key="quickStats" className="mb-6 p-0 sm:p-0">
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
              ...
              <SafeDailyLimit budgets={budgets} accounts={allAccounts} investments={modeInvestments} transactions={transactions} currentUser={user} subscriptions={subscriptions} formatCurrency={formatCurrency} />
