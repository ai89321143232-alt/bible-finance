...
- currency: извлекай из сообщения. "RUB" по умолчанию. "доллар" → "USD", "евро" → "EUR", "тенге" → "KZT", "белорусский рубль/белрубль" → "BYN", "гривна" → "UAH", "сум/узбекский сум" → "UZS". Если пользователь явно назвал валюту — используй её код.
